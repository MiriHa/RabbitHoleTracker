package com.lmu.trackingapp.sensor.activityrecognition
...
import com.lmu.trackingapp.models.ActivityTransitionType
import com.lmu.trackingapp.models.ActivityType
...
class ActivityRecognitionSensor : AbstractSensor(
    ...
    private fun getPendingIntent(context: Context): PendingIntent {
        ...
        return PendingIntent.getBroadcast(context, REQUEST_CODE_INTENT_ACTIVITY_TRANSITION, intent, PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
